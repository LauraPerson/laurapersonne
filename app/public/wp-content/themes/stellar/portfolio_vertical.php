...
<div id="page_content_wrapper" class="two nopadding gallery">
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
	    	...
	    	?>
	    	<div class="wall_entry type-post post gallery <?php if($portfolio_type=='Portfolio Content') { ?>ajax_portfolio<?php } ?> masonry element <?php echo $portfolio_item_set; ?>" data-id="post-<?php echo $key+1; ?>" data-type="<?php echo $portfolio_item_set; ?>">
	    		<?php 
			    	...
			    	<div class="wall_thumbnail">
						...
						<div style="display:none;">
						    <div id="video_self_<?php echo $key; ?>" class="lightbox_video_wrapper">
						        ...
						        <?php echo do_shortcode('[tg_video video_src="'.$portfolio_mp4_url.'" img_src="'.$small_image_url[0].'" width="960" height="540"]'); ?>
